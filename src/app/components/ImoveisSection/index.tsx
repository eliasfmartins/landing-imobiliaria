...
export const ImoveisSection = () => {
  return (
    <div className="mt-[80px] flex sm:justify-between items-center w-full/20 flex-wrap mb-[80px] p-4 justify-center gap-y-8">
      ...
      <CardImoveis imgUrl='casaimg.jpeg' cidade='Jardim Ingá' link='https://wa.me/p/7546592922067166/556191010404' title='Casa Jardim Ingá' valor='150.000' banheiros='1' quartos='2' vagas='2' />
    </div>
  );
};
